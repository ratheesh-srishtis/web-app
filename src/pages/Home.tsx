...
>
          ...
          <div className="row align-items-center text-divs ">
            ...
            <div className="col-lg-6 text-white mb-3 mb-lg-0">
              ...
              <p className="bannr-text-s text-light mt-3 mb-3">
                Solarvy helps homes and businesses estimate solar size, battery storage, diesel reduction, savings, and payback before speaking to installers or committing money.
              </p>

              <div className="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 mt-3">
                <button className="custom-btn mobile-viw"> Start Assessment
                  <img src={bttnarrow} alt="arrow" />
                </button>
            ...
            <div className="col-lg-5 offset-lg-1">
              ...
              >
                <h5 className="fw-bold text-center mb-3">Quick Assessment Preview</h5>

                <div className="row">
                  <div className="col-6">
                    <label className='quick-lable'>Property Type</label>
                    <select className="form-select select-text"
                      defaultValue=""
                      onChange={(e) => {
                ...
                <div className="row g-2 mb-3">
                  ...
                  <div className="col">
                    ...
                    <input
                      type="text"
                      className="form-control select-text"
                      placeholder="Reduce Diesel Use"
                    />
                  </div>
                </div>

                <button className="custom-btn other-section d-flex align-items-center justify-content-between w-100"> Start Assessment
      ...
      <section className="how-it-works py-4">
        <div className="container text-center">
          ...
          <p className="subtitle mb-5">
            A simple energy decision workflow built around problem-solving, not just calculations.
          </p>
          ...
          <div className="row g-4">
            ...
            <div className="col-md-4">
              <div className="step text-center">
                ...
                <p>
                  Estimate solar size, battery storage, hybrid setup, and likely value drivers.
                </p>
            ...
            <div className="col-md-4">
              <div className="step text-center">
                ...
                <p>
                  View system sizing, savings, payback, downloadable report, and next-step options.
                </p>
      ...
      <section className=" d-flex align-items-center bannar-see mt-4"  style={{
    backgroundImage: `url(${see})`
        ...
        <div className="container text-center mt-4 mb-3">
          ...
          <p className="subtitle">
            A simple energy decision workflow built around<br />
          ...
          <div className="row mt-3 g-4">
            ...
            <div className="col-md-6">
              ...
              <div className="card-box d-flex justify-content-between">
                ...
                <span className="text-muted text-color">Hybrid solar + battery</span>
              </div>
            </div>
              ...
              <div className="row g-4">
                ...
                <div className="col-6">
                  <div className="card-boxs text-center">
                    <small> <img src={enery} alt="icon" className='graph-image' />Solar PV</small>
                    <h3>28 kWp</h3>
                    <p>Indicative size</p>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="card-boxs text-center">
                    <small><img src={enery} alt="icon" className='graph-image' />Battery</small>
                    <h3>40 kWh</h3>
                    <p>Backup storage</p>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="card-boxs text-center">
                    <small><img src={enery} alt="icon" className='graph-image' />Annual savings</small>
                    <h3>NGN 7.8m</h3>
                    <p>Indicative</p>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="card-boxs text-center">
                    <small><img src={enery} alt="icon" className='graph-image' />Payback</small>
                    <h3>4.2 yrs</h3>
                    <p>Simple payback</p>
                  </div>
                </div>
      ...
      <section className="container built-cases text-center mt-4 mb-4">
        ...
        <div className="steps mt-3">
          ...
          <div className="step-s">
            <div className="image-box"> <img src={link} alt="icon" className='boxs-img' /></div>
            <h4 className='head-blue-left'>Homes</h4>
            <p className='sub-left'>
              Backup planning, appliance-based load estimation, and residential system sizing.
            </p>
          </div>
          ...
          <div className="step-s">
            <div className="image-box"> <img src={linkone} alt="icon" className='boxs-img' /></div>
          ...
          <div className="step-s">
            <div className="image-box"> <img src={linktwo} alt="icon" className='boxs-img'/></div>
        ...
        <div className="hero-section">
          ...
          <div className="overlay-wrapper">
            <div className="overlay-card">
              ...
              <p>
                Estimate the solar, battery, and hybrid system suited to your building,
                then download a structured report or request installer quotes.
              </p>

              <div className="d-flex justify-content-center align-items-center gap-3 mt-4 flex-wrap text-center">
                <button className="custom-btn other-section"> Start Assessment
                  <img src={bttnarrowhite} alt="arrow" />
                </button>

                <a href="#" className="see-link">See Sample Result</a>
              </div>
            </div>
          </div>
