...
function HowItWorks() {
          ...
          <div className="row align-items-center text-divs ass-text-bann">
            ...
            <div className="col-lg-12 text-white mb-3 mb-lg-0">
              ...
              <p className="bannr-text-second text-light mt-3 mb-3">
               Solarvy turns your bill, appliance data, or custom equipment inputs into a clear energy plan. It combines technical and financial logic so users can understand what system they need and what value it is likely to deliver.  </p>
  ...
  <p className="process-subtitle">
    Understand the full journey at a glance — from your first input
    <br />
 ...
 {/* Cards */}
  ...
  <div className="row g-4">
      ...
      <div className="next-card">
        ...
        <div className="card-content">
          <h6 className="title">
            ...
            <strong className='rang-heads'>Enter your details</strong> 
          </h6>

          <p className="desc">
           Provide your location, electricity bill, appliances, or custom equipment so Solarvy understands your building and energy usage.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="next-card">
        ...
        <div className="card-content">
          <h6 className="title">
            ...
            <strong className='rang-heads'>Analyse the energy environment</strong>
          </h6>

          <p className="desc">
            Solarvy models demand, local solar potential, system performance, and the likely cost implications of different energy paths.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="col-md-3">
      <div className="next-card">
        ...
        <div className="card-content">
          <h6 className="title">
            <strong className='rang-heads'>Compare system options</strong>
          </h6>

          <p className="desc">
           See practical strategy paths such as solar + grid, solar + battery, or hybrid setups with generator support where needed.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="next-card">
        ...
        <div className="card-content">
          <h6 className="title">
            ...
            <strong className='rang-heads'>Get your plan</strong>
          </h6>

          <p className="desc">
            Receive system sizing, indicative cost, savings, payback, and next steps including report download or installer quotes.  </p>
        </div>
      </div>
    </div>
  ...
  <div className="process-section text-center">
  <h2 className="process-title">What happens behind the scenes</h2>
  <p className="process-subtitle">
   Powerful modelling and financial logic work together to deliver
    <br />
  actionable results.
  </p>
</div>
